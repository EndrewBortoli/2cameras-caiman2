...
public class PhotonLL extends SubsystemBase {
  ...
  //PhotonCamera camera = new PhotonCamera("camara1");
  public PhotonCamera camera = new PhotonCamera("Camera_Module_v1");
  public PhotonCamera camera2 = new PhotonCamera("Camera_Left");
...
*/
    ...
    public boolean isAligned(){
      if(zRotation >= -170 && zRotation <= 170){
    ...
    //   return camToTarget.getRotation().getZ();
    // }
